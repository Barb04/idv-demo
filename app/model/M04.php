...
$documentType = "ppt_object";

try {
    $sessionResponse = BIDVerifyDocument::createDocumentSession($tenantInfo, $dvcId, $documentType);
    debug_log("BlockID Banking IDVerify raw response", json_encode($sessionResponse));
    ...
    debug_log("BlockID Banking IDVerify error", $e->getMessage());
